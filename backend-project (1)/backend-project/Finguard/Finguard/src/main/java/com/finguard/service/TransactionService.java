...
//        }
//
//        // 4. Fetch Onboarding records to check KYC status and Balance
//        CustomerOnboarding senderKyc = onboardingRepository.findByEmail(sender.getEmail())
//                .orElseThrow(() -> new RuntimeException("Sender is not KYC onboarded."));
//        CustomerOnboarding recipientKyc = onboardingRepository.findByEmail(recipient.getEmail())
//                .orElseThrow(() -> new RuntimeException("Recipient is not a valid onboarded customer."));
//
//        // 5. Balance Check
...
//        }
//
//        // 6. Risk Analysis Logic (Retained functionality)
//        String risk;
//        if (amount > 100000) {
//            risk = "HIGH";
...
//        }
//
//        // 7. Status Logic: High risk transactions stay PENDING for banker approval
...
//        tx.setStatus(status);
//
//        // 8. Immediate Balance Update for SUCCESS status
